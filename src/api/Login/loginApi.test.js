...
describe('LoginApi', () => {
    ...
    describe('login', () => {
        ...
        it('returns correct response if login credentials are incorrect', async () => {
            const expectedResponse = { error: 'Invalid login details. Please check your username and password and try again.' };
        ...
        it('returns correct response if server unavailable', async () => {
            const expectedResponse = { error: 'The server is unavailable. Please try again later.' };
    ...
    describe('logout', () => {
        ...
        it('returns correct response if logout not successful', async () => {
            const expectedResponse = { error: 'Server unavailable. Unable to log out. Please try again later.' };
